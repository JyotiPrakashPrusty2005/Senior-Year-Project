# Cardiovascular model training script
import pandas as pd
import joblib
import numpy as np
...
print("\n" + "="*60)
print("COMPARING MODELS ON CARDIOVASCULAR DATASET")
print("="*60)
...
print(f"\nBest model ({best_name}) saved to models/cardio_model.pkl")

# Save model
print("\nSaving model...")
joblib.dump(model, os.path.join(MODELS_DIR, "cardio_model.pkl"))
print(f"Model saved to {MODELS_DIR}/cardio_model.pkl")
print(f"Scaler saved to {MODELS_DIR}/cardio_scaler.pkl")